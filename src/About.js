...
import EmilyImage from './images/Emily.jpeg';
          ...
          <Grid container spacing={2} justifyContent="center">
            <Grid item xs={12} sm={4}>
              <Paper elevation={2} sx={{ p: 3, textAlign: 'center' }}>
                <img src={EmilyImage} alt="Emily Johnson" style={{ width: 100, height: 100, borderRadius: '50%' }} />
                <Typography variant="h6" gutterBottom>
                  Emily Johnson
                </Typography>
                <Typography variant="body2">
            ...
            <Grid item xs={12} sm={4}>
              <Paper elevation={2} sx={{ p: 3, textAlign: 'center' }}>
                <img src={JaneImage} alt="Jane Smith" style={{ width: 100, height: 100, borderRadius: '50%' }} />
                <Typography variant="h6" gutterBottom>
                  Jane Smith
                </Typography>
                <Typography variant="body2">
            ...
            <Grid item xs={12} sm={4}>
              <Paper elevation={2} sx={{ p: 3, textAlign: 'center' }}>
                <img src={JohnImage} alt="John Doe" style={{ width: 100, height: 100, borderRadius: '50%' }} />
                <Typography variant="h6" gutterBottom>
                  John Doe
                </Typography>
                <Typography variant="body2">
